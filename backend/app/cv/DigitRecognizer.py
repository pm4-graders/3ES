...
class DigitRecognizer:
    ...
    def recognize_digits_in_photo(self, photo):
        ...
        exam = cv_res.Exam(recognized_text[3], recognized_text[4], total_exam, total_score, total_score_confidence, exercises)  # TODO FILL number, score, total_score && replace year & subject & add exam id from recognized_text[0]
